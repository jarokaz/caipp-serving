...
This repo contains code samples that demonstrate how to serve TensorFlow 2.x models using AI Platform Prediction Custom Containers (Alpha) and [TensorFlow Serving](https://www.tensorflow.org/tfx/guide/serving). 
